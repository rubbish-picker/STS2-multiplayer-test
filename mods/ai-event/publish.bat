...
title ai-event Publish

set "SCRIPT_DIR=%~dp0"
set "PROJECT_DIR=%SCRIPT_DIR:~0,-1%"
set "PROJECT_FILE=%SCRIPT_DIR%ai-event.csproj"
set "OUTPUT_DIR=D:\steam\steamapps\common\Slay the Spire 2\mods\ai-event"
set "CONFIG_FILE=D:\githubprojects\AgentTheSpire\config.json"
set "GODOT_EXE="

echo.
echo ============================================
echo   ai-event Publish
echo ============================================
echo.
